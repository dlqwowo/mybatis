...
public class TypeParameterResolver {
   ...
   */
  // 原始类型 平常所指的类(Class)
  // 参数化类型(ParameterizedType) Map<String>,List<String>,List<?>,String[]
  // 数组类型(GenericArrayType) List<T>[] 、T[]
  // 类型变量(TypeVariable)  泛型中的变量；例如：T、K、V等变量，可以表示任何类
   ...
   *  srcType  传入class
   *  declaringClass  方法的类
   *  clazz  srcType的参数化，加上了通配符<?>
   *  superclass  srcType的超类
   */
